...
window.addEventListener('DOMContentLoaded', function() {
    ...
    if (user_info && document.getElementById('fname') && document.getElementById('auto_email')) {
        document.getElementById('fname').value = user_info.name;
        document.getElementById('auto_email').value = user_info.email;
    }
});
